...
test('hides sensitive fields from array representation', function () {
    $user = User::factory()->create([
        'password' => 'secret123',
...
test('identifies admin role correctly', function () {
...
test('identifies caregiver role correctly', function () {
    $admin = User::factory()->create(['role' => 'admin']);
    $caregiver = User::factory()->create(['role' => 'caregiver']);
    $client = User::factory()->create(['role' => 'client']);
...
test('identifies client role correctly', function () {
    $admin = User::factory()->create(['role' => 'admin']);
    $caregiver = User::factory()->create(['role' => 'caregiver']);
    $client = User::factory()->create(['role' => 'client']);
...
test('returns correct role label', function () {
    $admin = User::factory()->create(['role' => 'admin']);
    $caregiver = User::factory()->create(['role' => 'caregiver']);
    $client = User::factory()->create(['role' => 'client']);
