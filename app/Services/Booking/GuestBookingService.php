...
class GuestBookingService
{
    ...
    public function validateOnly(Request $request)
    {
        $validated = $request->validate([
            ...
            'address_line1' => 'nullable|required_if:location_type,private_home,vacation_rental,event_venue|string|max:500',
            'address_line2' => 'nullable|string|max:500',
            'address_city' => 'nullable|required_if:location_type,private_home,vacation_rental,event_venue|string|max:255',
            'address_state' => 'nullable|required_if:location_type,private_home,vacation_rental,event_venue|string|max:100',
            'address_zip' => 'nullable|required_if:location_type,private_home,vacation_rental,event_venue|string|max:20',
