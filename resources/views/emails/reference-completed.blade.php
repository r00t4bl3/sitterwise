...
<body>
    <div class="header">
        ...
        <p>{{ $referenceName }} has submitted a reference for {{ $applicantName }}</p>
    </div>
    <div class="content">
        <p>A reference has been completed for <strong>{{ $applicantName }}</strong> by <strong>{{ $referenceName }}</strong>.</p>
