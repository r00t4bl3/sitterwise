...
<body>
    ...
    <div class="content">
        ...
        <div style="text-align: center; margin: 24px 0;">
            <a clicktracking=off href="{{ route('applications.show', $applicationId) }}" style="display: inline-block; background: #F48A91; color: #fff !important; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">
                Review Application
            </a>
        </div>
    </div>
